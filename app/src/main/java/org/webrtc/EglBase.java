...
public interface EglBase {
  ...
  public static EglBase create(Object sharedContextObject, boolean is14) {
    Object egl = sharedContextObject;
    EglBase.Context context;
    if (is14) {
      context = new EglBase14Impl.Context((EGLContext) egl);
    } else {
      context = new EglBase10Impl.Context((javax.microedition.khronos.egl.EGLContext) egl);
    }
